...
const chao = {
    ...
    desenha(){
        ...
        // Repete para compeletar e muda a posição
        contexto.drawImage(
            sprites,
            chao.spriteX, chao.spriteY,
            chao.largura, chao.altura,
...
const flappyBird = {
    ...
    atualiza(){
        ...
        flappyBird.y = flappyBird.y + flappyBird.velocidade //Faz objeto cair
    },

    desenha(){
        contexto.drawImage (
            sprites,
            flappyBird.spriteX, flappyBird.spriteY, //Sprite X Strite Y
